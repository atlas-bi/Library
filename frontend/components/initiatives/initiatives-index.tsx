...
import { BadgeCheck, BarChart3, TrendingUp, Star, Share } from "lucide-react"
  ...
  return (
    <div className="mx-auto px-4 py-8">
      ...
      <nav className="mb-6 flex gap-2 text-[0.9rem] text-gray-500">
        <Link href="/initiatives" className="hover:underline">Initiatives</Link>
        <span>/</span>
      ...
      {data.initiatives.length === 0 ? (
        ...
        <div className="grid gap-6 md:grid-cols-2">
          {data.initiatives.map((item) => {
            ...
            const starCountDisplay = isStarred && !item.isStarred 
              ? (item.starCount || 0) + 1 

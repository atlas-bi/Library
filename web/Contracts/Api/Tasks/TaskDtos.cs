...
{
    public IReadOnlyList<TaskCanMakeReportDto> CanMakeReports { get; init; } =
        Array.Empty<TaskCanMakeReportDto>();
    public IReadOnlyList<TaskRetireReportDto> RecommendRetire { get; init; } =
        Array.Empty<TaskRetireReportDto>();
    public IReadOnlyList<TaskUnusedReportDto> Unused { get; init; } =
        Array.Empty<TaskUnusedReportDto>();
    public IReadOnlyList<TaskMaintenanceReportDto> MaintenanceRequired { get; init; } =
        Array.Empty<TaskMaintenanceReportDto>();
    public IReadOnlyList<TaskMaintenanceReportDto> Audit { get; init; } =
        Array.Empty<TaskMaintenanceReportDto>();
    public IReadOnlyList<TaskMaintenanceReportDto> MissingSchedule { get; init; } =
        Array.Empty<TaskMaintenanceReportDto>();
    public IReadOnlyList<TaskAnalyticsReportDto> NotInAnalytics { get; init; } =
        Array.Empty<TaskAnalyticsReportDto>();
    public IReadOnlyList<TaskUndocumentedReportDto> TopUndocumented { get; init; } =
        Array.Empty<TaskUndocumentedReportDto>();
    public IReadOnlyList<TaskUndocumentedReportDto> NewUndocumented { get; init; } =
        Array.Empty<TaskUndocumentedReportDto>();
}

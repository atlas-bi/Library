...
namespace Atlas_Web.Migrations
{
    ...
    [Migration("20220510172547_AddIndexForProfile")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Atlas_Web.Models.ReportObject", b =>
                {
                    ...
                    b.HasIndex("DefaultVisibilityYn");

                    SqlServerIndexBuilderExtensions.IncludeProperties(b.HasIndex("DefaultVisibilityYn"), new[] { "ReportObjectId", "EpicMasterFile" });

                    b.HasIndex("EpicMasterFile");

                    SqlServerIndexBuilderExtensions.IncludeProperties(b.HasIndex("EpicMasterFile"), new[] { "ReportObjectId", "ReportObjectTypeId" });

                    b.HasIndex("ReportObjectTypeId");

                    SqlServerIndexBuilderExtensions.IncludeProperties(b.HasIndex("ReportObjectTypeId"), new[] { "ReportObjectId", "EpicMasterFile" });

                    b.HasIndex("SourceDb");

                    SqlServerIndexBuilderExtensions.IncludeProperties(b.HasIndex("SourceDb"), new[] { "ReportObjectId", "EpicMasterFile" });

                    b.HasIndex("SourceServer");

                    SqlServerIndexBuilderExtensions.IncludeProperties(b.HasIndex("SourceServer"), new[] { "ReportObjectId", "EpicMasterFile" });

                    b.HasIndex("ReportObjectTypeId", "EpicMasterFile");

                    SqlServerIndexBuilderExtensions.IncludeProperties(b.HasIndex("ReportObjectTypeId", "EpicMasterFile"), new[] { "ReportObjectId", "CertificationTag" });

                    b.HasIndex("SourceDb", "EpicMasterFile");

                    SqlServerIndexBuilderExtensions.IncludeProperties(b.HasIndex("SourceDb", "EpicMasterFile"), new[] { "ReportObjectId" });

                    b.HasIndex("SourceServer", "EpicMasterFile");

                    SqlServerIndexBuilderExtensions.IncludeProperties(b.HasIndex("SourceServer", "EpicMasterFile"), new[] { "ReportObjectId" });

                    b.HasIndex("SourceServer", "ReportObjectTypeId");

                    SqlServerIndexBuilderExtensions.IncludeProperties(b.HasIndex("SourceServer", "ReportObjectTypeId"), new[] { "ReportObjectId" });

                    b.HasIndex("EpicMasterFile", "SourceServer", "ReportObjectTypeId");

                    SqlServerIndexBuilderExtensions.IncludeProperties(b.HasIndex("EpicMasterFile", "SourceServer", "ReportObjectTypeId"), new[] { "ReportObjectId" });
            ...
            modelBuilder.Entity("Atlas_Web.Models.ReportObjectReportRunTime", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<DateTime?>("RunWeek")
                        .HasColumnType("datetime");

                    b.Property<string>("RunWeekString")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.HasIndex(new[] { "ReportObjectId" }, "reportid")
                        .HasDatabaseName("reportid5");

                    b.ToTable("ReportObjectReportRunTime", "app");
                });

            modelBuilder.Entity("Atlas_Web.Models.ReportObjectRunDatum", b =>
                {
                    b.Property<int>("ReportObjectId")
                        .HasColumnType("int")
                        .HasColumnName("ReportObjectID");
                    ...
                    SqlServerIndexBuilderExtensions.IncludeProperties(b.HasIndex("RunStartTime"), new[] { "ReportObjectId", "RunUserId" });
            ...
            modelBuilder.Entity("Atlas_Web.Models.ReportObjectRunTime", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex(new[] { "RunUserId" }, "userid")
                        .HasDatabaseName("userid1");

                    b.ToTable("ReportObjectRunTime", "app");
                });
            ...
            modelBuilder.Entity("Atlas_Web.Models.ReportObjectTopRun", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex(new[] { "ReportObjectId" }, "report+user+type");

                    b.HasIndex(new[] { "ReportObjectId" }, "reportid + columns");

                    b.HasIndex(new[] { "RunUserId" }, "userid + columns");

                    b.ToTable("ReportObjectTopRuns", "app");
                });
            ...
            modelBuilder.Entity("Atlas_Web.Models.ReportObjectWeightedRunRank", b =>
                {
                    b.Property<int>("Reportobjectid")
                        .HasColumnType("int")
                        .HasColumnName("reportobjectid");

                    b.Property<decimal?>("WeightedRunRank")
                        .HasColumnType("numeric(12,4)")
                        .HasColumnName("weighted_run_rank");

                    b.HasIndex("Reportobjectid");

                    b.ToTable("ReportObjectWeightedRunRank", "app");
                });
            ...
            modelBuilder.Entity("Atlas_Web.Models.ReportObjectReportRunTime", b =>
                {
                    b.HasOne("Atlas_Web.Models.ReportObject", "ReportObject")
                        .WithMany("ReportObjectReportRunTimes")
                        .HasForeignKey("ReportObjectId")
            ...
            modelBuilder.Entity("Atlas_Web.Models.ReportObject", b =>
                {
                    ...
                    b.Navigation("ReportObjectReportRunTimes");

                    b.Navigation("ReportObjectRunData");
            ...
            modelBuilder.Entity("Atlas_Web.Models.User", b =>
                {
                    ...
                    b.Navigation("ReportObjectRunTimes");

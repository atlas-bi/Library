  ...
  \********************************/
    ...
    function (module, exports, __webpack_require__) {
      ...
      var FlowChart = __webpack_require__(/*! ./flowchart.chart */ 7),
        Start = __webpack_require__(/*! ./flowchart.symbol.start */ 13),
        End = __webpack_require__(/*! ./flowchart.symbol.end */ 10),
        Operation = __webpack_require__(/*! ./flowchart.symbol.operation */ 12),
        InputOutput = __webpack_require__(
          /*! ./flowchart.symbol.inputoutput */ 11,
        ),
        Subroutine = __webpack_require__(
          /*! ./flowchart.symbol.subroutine */ 14,
        ),
        ...
        (options = options || {}),
          ...
          !options.direction_no
            ? 'right' === options.direction_yes
              ...
              : 'top' === options.direction_yes
              ? ((this.no_direction = 'right'), (this.yes_direction = 'top'))
              : ((this.no_direction = 'right'), (this.yes_direction = 'bottom'))
            : options.yes &&
              !options.direction_yes &&
              options.no &&
              options.direction_no
            ? 'right' === options.direction_no
              ? ((this.yes_direction = 'bottom'), (this.no_direction = 'right'))

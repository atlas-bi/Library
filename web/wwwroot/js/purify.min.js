var module = (function () {
  ...
  var purify_min$1 = {exports: {}};

  purify_min$1.exports;
    ...
    !function (e, t) {
      ...
      function R(e, t) {
        for (; null !== e;) {
          var _n = r(e, t);
          if (_n) {
            if (_n.get) return N(_n.get);
            if ("function" == typeof _n.value) return N(_n.value);
          }
          e = o(e);
        }
        return function (e) {
        ...
        var st = function st(e) {
            ...
            if (!fe[n] || Te[n]) {
              ...
              if (Me && !Fe[n]) {
                var _t3 = $(e) || e.parentNode,
                  _n2 = V(e) || e.childNodes;
                if (_n2 && _t3) {
                  for (var _o2 = _n2.length - 1; _o2 >= 0; --_o2) _t3.insertBefore(G(_n2[_o2], !0), j(e));
                }
              }
              return mt(e), !0;
            }
          ...
          At = function At(e) {
            ...
            for (i = a.length; i--;) {
              ...
              if (Tt(_m, r, n)) {
                if (!Le || "id" !== r && "name" !== r || (ut(_c, e), n = Oe + n), Z && "object" == _typeof(z) && "function" == typeof z.getAttributeType) if (_s) ;else switch (z.getAttributeType(_m, r)) {
                  case "TrustedHTML":
                    n = Z.createHTML(n);
                    break;
                ...
                try {
                  _s ? e.setAttributeNS(_s, _c, n) : e.setAttribute(_c, n), u(o.removed);
                } catch (e) {}
              }
            }
  ...
  })(purify_min$1, purify_min$1.exports);
  var purify_minExports = purify_min$1.exports;
  var purify_min = /*@__PURE__*/getDefaultExportFromCjs(purify_minExports);

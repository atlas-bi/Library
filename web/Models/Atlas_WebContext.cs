...
namespace Atlas_Web.Models
{
    public partial class Atlas_WebContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            modelBuilder.Entity<Analytic>(
                entity =>
                {
                    ...
                    entity
                        ...
                        .IncludeProperties(
                            p => new { p.LoadTime, p.PageId, p.SessionId, p.Pathname }
                        );
                    entity
                        .HasIndex(e => e.AccessDateTime, "accessdatetime_session_width_agent")
                        .IncludeProperties(
                            p => new { p.PageId, p.SessionId, p.ScreenWidth, p.UserAgent }
                        );
            ...
            modelBuilder.Entity<EstimatedRunFrequency>(
                entity =>
                {
            ...
            modelBuilder.Entity<FinancialImpact>(
                entity =>
                {
            ...
            modelBuilder.Entity<FragilityTag>(
                entity =>
                {
            ...
            modelBuilder.Entity<GlobalSiteSetting>(
                entity =>
                {
            ...
            modelBuilder.Entity<MailConversation>(
                entity =>
                {
            ...
            modelBuilder.Entity<MailFolderMessage>(
                entity =>
                {
            ...
            modelBuilder.Entity<MailMessageType>(
                entity =>
                {
            ...
            modelBuilder.Entity<MailRecipientsDeleted>(
                entity =>
                {
            ...
            modelBuilder.Entity<MaintenanceLogStatus>(
                entity =>
                {
            ...
            modelBuilder.Entity<OrganizationalValue>(
                entity =>
                {
            ...
            modelBuilder.Entity<ReportObject>(
                entity =>
                {
                    ...
                    entity
                        ...
                        .IncludeProperties(
                            p => new { p.ReportObjectId, p.EpicMasterFile, p.Name, p.DisplayTitle }
                        );
                    entity
            ...
            modelBuilder.Entity<ReportObjectDoc>(
                entity =>
                {
            ...
            modelBuilder.Entity<ReportObjectDocFragilityTag>(
                entity =>
                {
            ...
            modelBuilder.Entity<ReportObjectDocTerm>(
                entity =>
                {
            ...
            modelBuilder.Entity<ReportObjectHierarchy>(
                entity =>
                {
                    entity
                    ...
                    entity
                        .Property(e => e.ChildReportObjectId)
            ...
            modelBuilder.Entity<ReportObjectImagesDoc>(
                entity =>
                {
            ...
            modelBuilder.Entity<StarredCollection>(
                entity =>
                {
            ...
            modelBuilder.Entity<StarredGroup>(
                entity =>
                {
            ...
            modelBuilder.Entity<StarredInitiative>(
                entity =>
                {
            ...
            modelBuilder.Entity<StarredReport>(
                entity =>
                {
            ...
            modelBuilder.Entity<StarredSearch>(
                entity =>
                {
            ...
            modelBuilder.Entity<StarredTerm>(
                entity =>
                {
            ...
            modelBuilder.Entity<StrategicImportance>(
                entity =>
                {
            ...
            modelBuilder.Entity<UserFavoriteFolder>(
                entity =>
                {
            ...
            modelBuilder.Entity<UserGroupsMembership>(
                entity =>
                {

...
"""
    test case for /initiatives urls
"""
...
class Initiatives(unittest.TestCase):
    ...
    def runTest(self):
        ...
        def test(driver, skip):
            report = self.my_site + "/initiatives"
            driver.get(report)
            time.sleep(1)
            ...
            driver.find_elements_by_css_selector("#newModal #DpDataInitiative_Name")[
                0
            ].send_keys("test initiative")
            time.sleep(1)
            ...
            # delete
            driver.find_elements_by_css_selector(
                'a.nav-link[data-tooltip="Delete this Initaitive"]'
            )[0].click()
            time.sleep(1)

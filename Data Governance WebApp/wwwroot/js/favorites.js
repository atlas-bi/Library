...
(function() {
    ...
    d.addEventListener('click', function(e) {
        if (e.target.closest('.favorite:not(.disabled)') || e.target.closest('.favorite-search:not(.disabled)') || e.target.closest('.fav-star:not(.disabled)') || e.target.closest('[fav-type]')) {
            e.preventDefault();
            e.stopPropagation();

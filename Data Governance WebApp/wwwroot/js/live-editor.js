...
(function(d, a) {
    "object" === typeof exports ? module.exports = a(window, document) : d.Editor = a(window, document)
})(this, function(d, a) {

    var x = function() {
        var l = function() {

            /* functions that do not bind to document/window/body are in the load function. Others are outside. */
            /* maint logs */
            ...
            if (document.getElementsByClassName('editor-buttonHidden').length > 0) {
                ...
                document.getElementById('report-edit-description-save-button').addEventListener('click', function(e) {
                    saveReportDescription();
                });
                document.getElementById('report-edit-keyassumptions-save-button').addEventListener('click', function(e) {
                ...
                document.querySelector('#editModal').addEventListener('submit', function(e) {
                ...
                /* images */
                document.querySelector('#editModal').addEventListener('change', function(e) {
                    if (e.target.matches('#report-add-image-input') && e.target.closest('#report-add-image-input').value != "") {
                        console.log("image upload", e.target.closest('#report-add-image-input'))
                        console.log(e.target.closest('#report-add-image-input').value)
        ...
        document.addEventListener('live-editor', function() {
            load();
        }, false);
        load();
    ...
    console.log("report editor scripts loaded.");
    return x;
});

...
(function() {
    ...
    document.addEventListener('change', function(e) {
        if (e.target.closest('#change-role')) {
            e.target.closest('form').querySelector('#MyRole_Url').value = window.location.href;
    ...
    function downloadJSAtOnload() {
        ...
        if (!!document.querySelector(".atlas-chart")) loadScripts(document.getElementsByClassName('chartScripts'));
        if (!!document.querySelector('input[type="nice-input"], textarea[type="nice-input"]')) loadScripts(document.getElementsByClassName('inputScripts'));
        if (!!document.querySelector('.comments-form')) loadScripts(document.getElementsByClassName('commentsScripts'));
        if (!!document.querySelector('[type="dynamic-dropdown"]')) loadScripts(document.getElementsByClassName('dropdownScripts'));

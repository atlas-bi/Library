            ...
            setTimeout(function() {
                ...
                for (var el = 0; el < dest.length; el++) {
                    ...
                    if (dest[el].getElementsByClassName('ajaxLoader').length > 0) {
                        dest[el].removeChild(dest[el].getElementsByClassName('ajaxLoader')[0]);
                    }
    ...
    build.prototype = {
        mouseover: function(b) {
            ...
            k(function() {
                ...
                hover = Array.prototype.slice.call(t.closest('table').getElementsByClassName('hover'));
                for (var x = 0; x < hover.length; x++) hover[x].classList.remove('hover');

                if (t.closest('.chart-head th')) {
                    lines = Array.prototype.slice.call(t.closest('table').getElementsByClassName('chart-line ' + t.closest('.chart-head th').getElementsByTagName('span')[0].classList.value.replace('chart-headClr', '')));
                    for (var x = 0; x < lines.length; x++) lines[x].classList.add('hover');
                    bars = Array.prototype.slice.call(t.closest('table').getElementsByClassName('chart-bar ' + t.closest('.chart-head th').getElementsByTagName('span')[0].classList.value.replace('chart-headClr', '')));

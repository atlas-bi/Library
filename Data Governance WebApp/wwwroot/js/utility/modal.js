...
(function() {
    ...
    document.addEventListener('click', function(e) {
        ...
        if (e.target.getAttribute('data-toggle') == 'mdl') {
            ...
            e.target.parentNode.previousElementSibling.getElementsByTagName('textarea')[0].value = "";
            closeModals();
    ...
    document.getElementById('shareModal').addEventListener('mdl-open', function(e) {
        ...
        modal.querySelector('.mlbx-newMsgMsg').innerHTML = "<div>Hi!<br>I would like to share this " + button.getAttribute('data-type') + " with you.</div><br><a href='" + url + "'>" + name + "</a><br><br><div>Check it out sometime!</div><br><div>Regards!<br>" + modal.querySelector('.mlbx-newMsgSender span:nth-child(2)').innerHTML;
    ...
    document.getElementById('shareFeedback').addEventListener('mdl-open', function(e) {
        ...
        var modal = this;
        modal.querySelector('.mdl-h h2').innerHTML = button.getAttribute('data-tooltip');
        modal.querySelector('.share-feedback').setAttribute('report-name', name);

    });

    document.getElementById('requestAccessModal').addEventListener('mdl-open', function(e) {
        var button = e.detail.e;

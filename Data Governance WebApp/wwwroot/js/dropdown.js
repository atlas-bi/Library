    ...
    */
    ...
    function build(b) {
        ...
        for (o = 0; o < s.length; o++) {
            ...
            var userDrop = '';
            if (b.hasAttribute('search-area') && b.getAttribute('search-area') == 'UserSearchMail') {
                var split = s[o].classList.contains('group') ? '<div class="mlbx-usrDrpItm">Expand Group</div>' : '';
                userDrop = '<div class="mlbx-usrDrp"><i class="fas fa-angle-down fa-sm"></i><div class="mlbx-usrDrpCtr"><div class="mlbx-usrDrpItm mail-new-message" data-from="Analytics" data-fromid="45781">New Mail</div>' + split + '<div class="separator"></div><div class="mlbx-usrDrpItm"><a class="ajax" href="/users?id=45781">Open Profile</a></div></div></div>';
            }
    ...
    build.prototype = {
        keydn: function(b) {
            ...
            if (key == 8 && i.value.length == 0 && t == 'SELECT' && ipt.previousElementSibling) { // backspace
                k(function() {
                    o = h.getElementsByTagName("option");
                    for (var g = 0; g < o.length; g++) {
                        if (o[g].childNodes[0].nodeValue == ipt.previousElementSibling.childNodes[0].nodeValue) {
                            o = o[g];
            ...
            } else if (key == 37 && t == 'SELECT' && ipt.previousElementSibling && ipt.previousElementSibling.matches('.dd-itm') && i.selectionStart == 0) { // left arrow
                k(function() {
                ...
                k(function() {
                    ...
                    if (r.querySelectorAll('.dd-rslt:not(.hidden):not(.disabled)').length > 0 && r.getElementsByClassName('disabled') !== null) {
                        r.getElementsByClassName('disabled')[0].parentElement.removeChild(r.getElementsByClassName('disabled')[0]);
                    }
                ...
                var inputs = document.querySelectorAll('input, select, div[contenteditable="true"]');
                var vInputs = [];
                ...
                k(function() {
                    ...
                    if (el) {
                        ...
                        if (o == 0) {
                            newEl = el.parentElement.children[el.parentElement.children.length - 1];
                        } else {
                    ...
                    } else if (newEl.offsetTop > newEl.parentElement.scrollTop + newEl.parentElement.clientHeight + 3) {
                ...
                k(function() {
                    ...
                    newEl.classList.add('active');
                    if (newEl.offsetTop + newEl.clientHeight > newEl.parentElement.scrollTop + newEl.parentElement.clientHeight) {
                        newEl.parentElement.scrollTop += newEl.clientHeight;
                    } else if (newEl.offsetTop + newEl.clientHeight < newEl.parentElement.scrollTop + 3) {
                        newEl.parentElement.scrollTop = newEl.offsetTop - 3;
                    }
                });
            }
        ...
        unfcs: function(b) {
            var i = this.ddVsbl,
                ...
                hi = this.ddHdn;
            k(function() {
                if (b.relatedTarget != null && b.relatedTarget.closest('.dd-cntr') == c) {
                    return;
                } else {
        ...
        click: function(b) {
            ...
            k(function() {
                ...
                if (b.target.closest('.dd-rslt')) {
                    ...
                    if (type == 'SELECT') {
                        i.value = '';
                        if (typeof method != 'undefined' && method !== false && method !== null) {
                        ...
                        var group = '';
                        var userDrop = '';
                        if (i.hasAttribute('search-area') && i.getAttribute('search-area') == 'UserSearchMail') {
                            group = actv.classList.contains('group') ? 'group' : '';
                            var split = actv.classList.contains('group') ? '<div class="mlbx-usrDrpItm">Expand Group</div>' : '';
                            userDrop = '<div class="mlbx-usrDrp"><i class="fas fa-angle-down fa-sm"></i><div class="mlbx-usrDrpCtr"><div class="mlbx-usrDrpItm mail-new-message" data-from="Analytics" data-fromid="45781">New Mail</div>' + split + '<div class="separator"></div><div class="mlbx-usrDrpItm"><a class="ajax" href="/users?id=45781">Open Profile</a></div></div></div>';
                        }
                    ...
                    if (dd.querySelector('.dd-itm') && b.target.closest('.mlbx-usrDrp') == null) {
                        ...
                        for (var g = 0; g < itms.length; g++) {
                            if (mouseY > getOffset(itms[g]).top && mouseY < getOffset(itms[g]).top + itms[g].clientHeight) {
                                myItms.push(itms[g]);
                            }
                        }
                    ...
                    if (el.value.trim().length > 0) {
                        ...
                        q.onload = function() {
                            ...
                            var rsL = getOffset(rs).left + rs.clientWidth,
                                ctnL = getOffset(ctn.parentElement).left + ctn.parentElement.clientWidth;
                            if (rsL > ctnL) {

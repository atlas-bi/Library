...
(function() {
    function UpdateMilestoneChecklistItems(e) {
        ...
        if (null == e.nextElementSibling || (null !== e.nextElementSibling && !e.nextElementSibling.classList.contains("checklistitem") && e.nextElementSibling.innerHTML !== 'Task')) {
            var n = e.cloneNode(!0),
    ...
    document.addEventListener("click", function(e) {
        if (e.target.matches(".checklistitem")) UpdateMilestoneChecklistItems(e.target);
    });

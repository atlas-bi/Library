/*! highlight.js v9.17.0 | BSD3 License | git.io/hljslicense */ ! function(e) {
    ...
    function B(t, i, n, e) {
        ...
        function o() {
            m += null != p.sL ? function() {
                ...
                var e, t, r, a, n, i, s;
                if (!p.k) return M(g);
                for (a = "", t = 0, p.lR.lastIndex = 0, r = p.lR.exec(g); r;) a += M(g.substring(t, r.index)), n = p, i = r, void 0, s = b.cI ? i[0].toLowerCase() : i[0], (e = n.k.hasOwnProperty(s) && n.k[s]) ? (_ += e[1], a += c(e[0], M(r[0]))) : a += M(r[0]), t = p.lR.lastIndex, r = p.lR.exec(g);
        ...
        function r(e, t) {
            ...
            if ("end" === t.type) {
                var a = function(e) {
                    ...
                    if (a) {
                        var n = p;
                        for (n.skip ? g += t : (n.rE || n.eE || (g += t), o(), n.eE && (g = t)); p.cN && (m += k), p.skip || p.sL || (_ += p.relevance), (p = p.parent) !== a.parent;);
                        return a.starts && (a.endSameAsBegin && (a.starts.eR = a.eR), l(a.starts)), n.rE ? 0 : t.length
                    }
                }(t);
                if (null != a) return a
            }
    ...
    function v(e) {
        var t, r, a, n, i, s = function(e) {
            ...
            if (i += e.parentNode ? e.parentNode.className : "", r = o.exec(i)) {
                var s = A(r[1]);
            ...
            for (t = 0, a = (i = i.split(/\s+/)).length; t < a; t++)
                if (l(n = i[t]) || A(n)) return n
        }(e);
        l(s) || (E.useBR ? (t = document.createElement("div")).innerHTML = e.innerHTML.replace(/\n/g, "").replace(/<br[ \/]*>/g, "\n") : t = e, i = t.textContent, a = s ? B(s, i, !0) : R(i), (r = p(t)).length && ((n = document.createElement("div")).innerHTML = a.value, a.value = f(r, p(n), i)), a.value = h(a.value), e.innerHTML = a.value, e.className = function(e, t, r) {
            var a = t ? c[t] : r,
                n = [e.trim()];
    ...
    return n.highlight = B, n.highlightAuto = R, n.fixMarkup = h, n.highlightBlock = v, n.configure = function(e) {
        E = d(E, e)
        ...
        g(N[t] = r), r.rawDefinition = e.bind(null, n), r.aliases && r.aliases.forEach(function(e) {
            c[e] = t
        })
    ...
    }, n.autoDetection = L, n.inherit = d, n.debugMode = function() {
        w = !1

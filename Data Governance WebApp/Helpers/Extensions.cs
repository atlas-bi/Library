...
namespace Data_Governance_WebApp.Helpers
{
    ...
    {
        public static Boolean IsAdmin(IMemoryCache cache, Data_GovernanceContext _context, string username)
        {
        ...
        public static List<UserPreferences> GetPreferences(IMemoryCache cache, Data_GovernanceContext _context, string username)
        {
            username = username ?? "default";
            return cache.GetOrCreate<List<UserPreferences>>("Preferences-" + username,
                cacheEntry => {
        ...
        public static MyRole GetMyRole(IMemoryCache cache, Data_GovernanceContext _context, string username)
        {
            username = username ?? "default";
        ...
        public static User GetUser(IMemoryCache cache, Data_GovernanceContext _context, string username)
        {
            username = username ?? "default";
            return cache.GetOrCreate<User>("User-"+ username,
                cacheEntry => {
                    ...
                    return _context.User.Where(u => u.Username.Equals(username)).FirstOrDefault();
                });
            
        }

        public static List<UserFavorites> GetUserFavorites(IMemoryCache cache, Data_GovernanceContext _context, string username)
        {
            username = username ?? "default";
            return cache.GetOrCreate<List<UserFavorites>>("Favorites-" + username,
                cacheEntry => {
                    cacheEntry.SlidingExpiration = TimeSpan.FromHours(2);
        ...
        public static List<int?> GetUserPermissions(IMemoryCache cache, Data_GovernanceContext _context, string username)
        {
            username = username ?? "default";
        ...
        public static Boolean CheckUserPermissions(IMemoryCache cache, Data_GovernanceContext _context, string username, int Access)
        {
            username = username ?? "default";
    ...
    public class HtmlHelpers
    {
        ...
        public static string MilestoneFrequencyName(DpMilestoneTemplates content, string name)
        {
            if (name is null)
            {
                return "invalid";
        ...
        public static List<TaskData> GetMilestoneTaskDates(Data_Governance_WebApp.Pages.Projects.IndexModel.MilestoneTasksData task)
        {
            int counter;
        ...
        public static List<TaskData> GetMilestoneCalendar(List<Data_Governance_WebApp.Pages.Projects.IndexModel.MilestoneTasksData> Tasks)
        {
            var list = new List<TaskData>();

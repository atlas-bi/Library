USE [master]
GO
/****** Object:  Database [DG_Staging]    Script Date: 8/11/2020 9:07:19 AM ******/
CREATE DATABASE [DG_Staging]
 CONTAINMENT = NONE
 ON  PRIMARY 
( NAME = N'DG_Staging', FILENAME = N'E:\Program Files\Microsoft SQL Server\MSSQL13.MSSQLSERVER\MSSQL\DATA\DG_Staging.mdf' , SIZE = 2498560KB , MAXSIZE = UNLIMITED, FILEGROWTH = 65536KB )
 LOG ON 
( NAME = N'DG_Staging_log', FILENAME = N'F:\Program Files\Microsoft SQL Server\MSSQL13.MSSQLSERVER\MSSQL\Data\DG_Staging_log.ldf' , SIZE = 139264KB , MAXSIZE = 2048GB , FILEGROWTH = 65536KB )
GO
ALTER DATABASE [DG_Staging] SET COMPATIBILITY_LEVEL = 130
GO
...
USE [DG_Staging]
GO
/****** Object:  Schema [raw]    Script Date: 8/11/2020 9:07:21 AM ******/
CREATE SCHEMA [raw]
GO
/****** Object:  Schema [stage]    Script Date: 8/11/2020 9:07:21 AM ******/
CREATE SCHEMA [stage]
GO
/****** Object:  Table [raw].[Clarity_Username_Domainname_Links]    Script Date: 8/11/2020 9:07:21 AM ******/
SET ANSI_NULLS ON
GO
...
GO
/****** Object:  Table [stage].[ReportObjectHierarchyStaging]    Script Date: 8/11/2020 9:07:21 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [stage].[ReportObjectRunDataStaging]    Script Date: 8/11/2020 9:07:21 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [stage].[ReportObjectStaging]    Script Date: 8/11/2020 9:07:21 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
